...
public static class ClaimsPrincipalExtensions
{
	...
	public static bool IsMatchVerifier(this ClaimsPrincipal claimsPrincipal) => claimsPrincipal.IsInRole("verifier") || IsAdmin(claimsPrincipal) || IsSystem(claimsPrincipal);
}