...
public class RatingsRepository : RepositoryBase<Rating>, IRatingsRepository
{
	private readonly OtrContext _context;
	private readonly IPlayerRepository _playerRepository;

	public RatingsRepository(OtrContext context, IPlayerRepository playerRepository) : base(context)
	{
		_context = context;
		_playerRepository = playerRepository;
	}

	public async Task<IEnumerable<Rating>> GetForPlayerAsync(long osuPlayerId)
	{
		...
		return await _context.Ratings.Where(x => x.PlayerId == dbId).ToListAsync();
	}
