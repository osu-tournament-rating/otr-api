...
/// </summary>
public class TournamentsFilterDTO
{
    /// <summary>
    ...
    /// <summary>
    /// Filters results for <see cref="Database.Entities.Tournament"/>s with a partially
    /// matching <see cref="Database.Entities.Tournament.Name"/>
    /// or <see cref="Database.Entities.Tournament.Abbreviation"/>
    /// </summary>
    public string? Name { get; set; }

    /// <summary>
    /// Filters results for <see cref="Database.Entities.Tournament"/>s with a
    /// matching <see cref="Database.Entities.Tournament.LobbySize"/>
    /// </summary>
    public int? LobbySize { get; set; }

    /// <summary>
    /// Filters results for <see cref="Database.Entities.Tournament"/>s with a
    /// matching <see cref="Database.Entities.Tournament.RankRangeLowerBound"/>
    /// </summary>
    ...
    /// <summary>
    /// Filters results for <see cref="Database.Entities.Tournament"/>s where the id of the
    ...
    /// <summary>
    /// Controls the filtering options for the included <see cref="Database.Entities.Match"/>es
    /// </summary>
    public MatchesFilterDTO? Matches { get; set; }
}
