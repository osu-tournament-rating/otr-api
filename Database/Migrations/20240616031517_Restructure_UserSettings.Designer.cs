...
namespace Database.Migrations
{
    ...
    [Migration("20240616031517_Restructure_UserSettings")]
    partial class Restructure_UserSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.BaseStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Database.Entities.MatchDuplicate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.MatchHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.MatchRatingStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.RatingAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Match", b =>
                {
                    b.HasOne("Database.Entities.User", "SubmittedBy")
                    ...
                    b.HasOne("Database.Entities.User", "VerifiedBy")
            ...
            modelBuilder.Entity("Database.Entities.MatchDuplicate", b =>
                {
                    b.HasOne("Database.Entities.User", "Verifier")
            ...
            modelBuilder.Entity("Database.Entities.MatchHistory", b =>
                {
                    b.HasOne("Database.Entities.Match", "ReferenceMatch")
                        .WithMany()
