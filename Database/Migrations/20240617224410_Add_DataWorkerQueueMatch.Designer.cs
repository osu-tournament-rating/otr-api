...
namespace Database.Migrations
{
    ...
    [Migration("20240617224410_Add_DataWorkerQueueMatch")]
    partial class Add_DataWorkerQueueMatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.DataWorkerQueueMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_worker_queue_matches");
                });
            ...
            modelBuilder.Entity("Database.Entities.MatchScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Processor.BaseStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Processor.GameWinRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Processor.MatchRatingAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("match_rating_adjustments");
                });

            modelBuilder.Entity("Database.Entities.Processor.MatchWinRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Processor.PlayerMatchStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Database.Entities.Processor.GameWinRecord", b =>
                {
                    b.HasOne("Database.Entities.Game", "Game")
                        .WithOne("WinRecord")
                        .HasForeignKey("Database.Entities.Processor.GameWinRecord", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Database.Entities.Processor.MatchRatingAdjustment", b =>
                {
                    b.HasOne("Database.Entities.Match", "Match")
                        .WithMany("MatchRatingAdjustments")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Database.Entities.Processor.MatchWinRecord", b =>
                {
                    b.HasOne("Database.Entities.Match", "Match")
                        .WithOne("WinRecord")
                        .HasForeignKey("Database.Entities.Processor.MatchWinRecord", "MatchId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
            ...
            modelBuilder.Entity("Database.Entities.Match", b =>
                {
                    ...
                    b.Navigation("MatchRatingAdjustments");
