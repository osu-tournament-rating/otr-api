...
{
	public static IBaseStatsService BaseStatsService(OtrContext context) => new BaseStatsService(
		RepositoryInstances.BaseStatsRepository(context),
	...
	public static IBeatmapService BeatmapService(OtrContext context) => new BeatmapService(
		RepositoryInstances.BeatmapRepository(context),
		ConfigurationInstances.Mapper
	);

	public static IPlayerService PlayerService(OtrContext context) => new PlayerService(
		RepositoryInstances.PlayerRepository(context),
		ConfigurationInstances.Mapper
	);

	public static IPlayerStatsService PlayerStatsService(OtrContext context) => new PlayerStatsService(
		RepositoryInstances.PlayerRepository(context),
		RepositoryInstances.PlayerMatchStatsRepository(context),
		RepositoryInstances.MatchRatingStatsRepository(context),
	...
	public static ILeaderboardService LeaderboardService(OtrContext context) => new LeaderboardService(
		RepositoryInstances.PlayerRepository(context),
		BaseStatsService(context),
		RepositoryInstances.MatchRatingStatsRepository(context),
		PlayerService(context),
		PlayerStatsService(context)
	);

	public static IMatchesService MatchesService(OtrContext context) => new MatchesService(
		Mock.Of<ILogger<MatchesService>>(),
	...
	public static IUserService UserService(OtrContext context) => new UserService(
		RepositoryInstances.UserRepository(context)
	);
