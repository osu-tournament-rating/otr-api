...
public class MockMatchStatsRepository : Mock<IPlayerMatchStatsRepository>
{
	...
	{
		Setup(x => x.CountMatchesPlayedAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime?>(), It.IsAny<DateTime?>()))
			.ReturnsAsync(1000);
	...
	{
		Setup(x => x.GlobalWinrateAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime?>(), It.IsAny<DateTime?>()))
			.ReturnsAsync(0.75);
