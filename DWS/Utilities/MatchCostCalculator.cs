...
public static class MatchCostCalculator
{
    ...
    /// <remarks>
    /// Only <see cref="GameScore"/>s with a <see cref="VerificationStatus"/> of <see cref="VerificationStatus.Verified"/> are considered
    /// </remarks>
    ...
    private static IEnumerable<GameScore> WhereValid(this IEnumerable<GameScore> scores) =>
        scores.Where(s => s.VerificationStatus == VerificationStatus.Verified);
}
