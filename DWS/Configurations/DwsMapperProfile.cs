...
public class DwsMapperProfile : Profile
{
    ...
    private void CreateGameScoreMappings()
    {
        ...
        CreateMap<ApiGameScore, DbGameScore>()
            ...
            .ForMember(dest => dest.Count300, opt => opt.MapFrom(src => src.Statistics.Count300))
            .ForMember(dest => dest.Count100, opt => opt.MapFrom(src => src.Statistics.Count100))
            .ForMember(dest => dest.Count50, opt => opt.MapFrom(src => src.Statistics.Count50))
            .ForMember(dest => dest.CountMiss, opt => opt.MapFrom(src => src.Statistics.CountMiss))
            .ForMember(dest => dest.CountGeki, opt => opt.MapFrom(src => src.Statistics.CountGeki))
            .ForMember(dest => dest.CountKatu, opt => opt.MapFrom(src => src.Statistics.CountKatu))
