...
/// <summary>
/// The status of a <see cref="Match"/> in the processing flow
/// </summary>
public enum MatchProcessingStatus
{
    /// <summary>
    /// The <see cref="Match"/> needs data requested from the osu! API
    /// </summary>
    NeedsData = 0,

    /// <summary>
    /// The <see cref="Match"/> needs automation checks
    /// </summary>
    NeedsAutomationChecks = 1,

    /// <summary>
    /// The <see cref="Match"/> is awaiting verification from a
    /// <see cref="Database.Entities.User"/> with verifier permission
    /// </summary>
    NeedsVerification = 2,

    /// <summary>
    /// The <see cref="Match"/> needs stat calculation
    /// </summary>
