...
public class MultiplayerGame : IModel
{
    ...
    /// <summary>
    /// The <see cref="Common.Enums.Enums.ScoringType"/> used for the game
    /// </summary>
    [ValueConverter(typeof(ScoringTypeConverter))]
    public ScoringType ScoringType { get; init; }

    /// <summary>
    /// The <see cref="Common.Enums.Enums.TeamType"/> used for the game
    /// </summary>
    [ValueConverter(typeof(TeamTypeConverter))]
    public TeamType TeamType { get; init; }

    /// <summary>
    /// Any <see cref="Common.Enums.Enums.Mods"/> forced on the lobby
    /// </summary>
